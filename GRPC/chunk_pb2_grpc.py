...
class FileServerStub(object):
    ...
    def __init__(self, channel):
        ...
        self.TransferFile = channel.unary_unary(
                ...
                request_serializer=chunk__pb2.TransferRequest.SerializeToString,
                response_deserializer=chunk__pb2.TransferResponse.FromString,
                )
...
def add_FileServerServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'TransferFile': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=chunk__pb2.TransferRequest.FromString,
                    response_serializer=chunk__pb2.TransferResponse.SerializeToString,
            ),
    }
...
class FileServer(object):
    ...
    def TransferFile(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/FileServer/TransferFile',
            chunk__pb2.TransferRequest.SerializeToString,
            chunk__pb2.TransferResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)

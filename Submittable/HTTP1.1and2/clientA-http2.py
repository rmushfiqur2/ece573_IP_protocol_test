...
server_ip_addr = '10.153.50.73' # internal ip addr (on same AP/ public ip address)
server_port = '8080'
...
transfer_times, content_bytes, header_bytes = receive_http2(100, host, source_url, destination_url, n_outstanding_req=10)

...
# these are just keys, not actual settings, actual values are initialized wihtin _setting of Settings object
class SettingCodes(enum.IntEnum):
    ...
    #: flow control.
    INITIAL_WINDOW_SIZE = SettingsFrame.INITIAL_WINDOW_SIZE # mushfiq
    ...
    MAX_FRAME_SIZE = _max_frame_size #mushfiq
...
class Settings(collections.MutableMapping):
    ...
    def __init__(self, client=True, initial_values=None):
        ...
        self._settings = {
            ...
            SettingCodes.INITIAL_WINDOW_SIZE: collections.deque([10885760]), # mushfiq changed from 64 kB to 10MB
            SettingCodes.MAX_FRAME_SIZE: collections.deque([10885760]), # mushfiq changed from 16 kB to 10MB
        }
